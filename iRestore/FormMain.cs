    ...
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            using (var client = new WebClient())
            {
                try
                {
                    version = client.DownloadString("https://raw.githubusercontent.com/hellisabove/iRestore/master/futurerestore");
                    hashsum = client.DownloadString("https://raw.githubusercontent.com/hellisabove/iRestore/master/hashsum");
                }
                catch
                {
